...
function computeCapturedVariableNames(file) {
    ...
    function walk(node) {
        ...
        switch (node.kind) {
            ...
            case ts.SyntaxKind.ClassExpression:
                return visitClassDeclarationOrExpression(node);
            case ts.SyntaxKind.ArrowFunction:
                return visitBaseFunction(node, 
    ...
    function visitClassDeclarationOrExpression(node) {
        ...
        node.members.forEach((m) => {
            ...
            if ((m.kind === ts.SyntaxKind.PropertyAssignment || m.kind === ts.SyntaxKind.PropertyDeclaration) &&
