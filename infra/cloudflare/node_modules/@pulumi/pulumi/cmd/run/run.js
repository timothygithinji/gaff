...
async function npmPackageRootFromProgramPath(programPath) {
    ...
    const manifestPath = manifest_1.searchupPackageManifest(programDirectory);
    if (manifestPath === undefined) {
        log.warn("Could not find a package.json or package.yaml file for the program. " +
...
function packageObjectFromProjectRoot(projectRoot) {
    try {
        return manifest_1.readPackageManifest(projectRoot).data;
    }
    catch {
