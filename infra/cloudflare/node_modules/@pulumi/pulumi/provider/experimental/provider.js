 ...
 */
function isComponentResourceConstructor(value) {
...
exports.isComponentResourceConstructor = isComponentResourceConstructor;
/**
 ...
 * @internal exported for testing
 */
function validateExplicitComponents(components, warn = console.warn) {
    const valid = [];
    for (const c of components) {
        if (isComponentResourceConstructor(c)) {
            ...
            const label = (typeof c === "function" && c.name) || String(c);
            warn(`componentProviderHost: '${label}' is not a ComponentResource subclass and will be ` +
...
exports.validateExplicitComponents = validateExplicitComponents;
/**
...
class ComponentProvider {
    constructor(options) {
        ...
        this.packageJSON = manifest_1.readPackageManifest(absDir).data;
        this.path = absDir;
