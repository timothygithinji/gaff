 ...
 * ```
 */
export declare class ZeroTrustAccessKeyConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustAccessKeyConfigurationState, opts?: pulumi.CustomResourceOptions): ZeroTrustAccessKeyConfiguration;
    /**
     ...
     */
    static isInstance(obj: any): obj is ZeroTrustAccessKeyConfiguration;
    /**
     * Identifier.
     */
...
//# sourceMappingURL=zeroTrustAccessKeyConfiguration.d.ts.map