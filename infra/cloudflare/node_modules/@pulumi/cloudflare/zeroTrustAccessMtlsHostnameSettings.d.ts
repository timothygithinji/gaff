...
export interface ZeroTrustAccessMtlsHostnameSettingsState {
    ...
    settings?: pulumi.Input<pulumi.Input<inputs.ZeroTrustAccessMtlsHostnameSettingsSetting>[] | undefined>;
    /**
     * The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
     */
...
//# sourceMappingURL=zeroTrustAccessMtlsHostnameSettings.d.ts.map