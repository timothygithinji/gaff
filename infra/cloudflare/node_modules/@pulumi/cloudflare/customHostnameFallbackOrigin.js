...
class CustomHostnameFallbackOrigin extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new CustomHostnameFallbackOrigin(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'cloudflare:index/customHostnameFallbackOrigin:CustomHostnameFallbackOrigin';
    /**
