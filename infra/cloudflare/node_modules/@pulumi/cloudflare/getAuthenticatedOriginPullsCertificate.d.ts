 ...
 * ```
 */
export declare function getAuthenticatedOriginPullsCertificate(args: GetAuthenticatedOriginPullsCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthenticatedOriginPullsCertificateResult>;
/**
 ...
 * ```
 */
export declare function getAuthenticatedOriginPullsCertificateOutput(args: GetAuthenticatedOriginPullsCertificateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuthenticatedOriginPullsCertificateResult>;
/**
 * A collection of arguments for invoking getAuthenticatedOriginPullsCertificate.
 */
...
//# sourceMappingURL=getAuthenticatedOriginPullsCertificate.d.ts.map