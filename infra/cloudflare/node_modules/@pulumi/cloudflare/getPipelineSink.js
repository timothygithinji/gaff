...
exports.getPipelineSinkOutput = exports.getPipelineSink = void 0;
 ...
 * ```
 */
function getPipelineSink(args, opts) {
    args = args || {};
...
exports.getPipelineSink = getPipelineSink;
/**
 * Accepted Permissions
 *
 * - `Pipelines Read`
 ...
 * ```
 */
function getPipelineSinkOutput(args, opts) {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getPipelineSinkOutput = getPipelineSinkOutput;
//# sourceMappingURL=getPipelineSink.js.map