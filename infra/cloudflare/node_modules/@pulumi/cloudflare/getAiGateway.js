...
exports.getAiGatewayOutput = exports.getAiGateway = void 0;
 ...
 * ```
 */
function getAiGateway(args, opts) {
    args = args || {};
 ...
 * ```
 */
function getAiGatewayOutput(args, opts) {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getAiGatewayOutput = getAiGatewayOutput;
//# sourceMappingURL=getAiGateway.js.map