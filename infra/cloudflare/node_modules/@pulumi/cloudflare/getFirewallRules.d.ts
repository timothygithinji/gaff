 ...
 * ```
 */
export declare function getFirewallRules(args?: GetFirewallRulesArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallRulesResult>;
/**
 ...
 * ```
 */
export declare function getFirewallRulesOutput(args?: GetFirewallRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFirewallRulesResult>;
/**
 * A collection of arguments for invoking getFirewallRules.
 */
...
//# sourceMappingURL=getFirewallRules.d.ts.map