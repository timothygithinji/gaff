...
export declare class AccessCaCertificate extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccessCaCertificateState, opts?: pulumi.CustomResourceOptions): AccessCaCertificate;
    /**
...
//# sourceMappingURL=accessCaCertificate.d.ts.map