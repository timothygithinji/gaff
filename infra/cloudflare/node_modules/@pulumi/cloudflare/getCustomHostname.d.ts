 ...
 * ```
 */
export declare function getCustomHostname(args?: GetCustomHostnameArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomHostnameResult>;
/**
 ...
 * ```
 */
export declare function getCustomHostnameOutput(args?: GetCustomHostnameOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCustomHostnameResult>;
/**
 * A collection of arguments for invoking getCustomHostname.
 */
...
//# sourceMappingURL=getCustomHostname.d.ts.map