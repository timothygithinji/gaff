 ...
 * ```
 */
export declare class CustomHostnameFallbackOrigin extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CustomHostnameFallbackOriginState, opts?: pulumi.CustomResourceOptions): CustomHostnameFallbackOrigin;
    /**
...
//# sourceMappingURL=customHostnameFallbackOrigin.d.ts.map