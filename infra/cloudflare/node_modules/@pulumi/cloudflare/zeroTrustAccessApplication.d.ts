...
export declare class ZeroTrustAccessApplication extends pulumi.CustomResource {
     ...
     */
    readonly mfaConfig: pulumi.Output<outputs.ZeroTrustAccessApplicationMfaConfig | undefined>;
    /**
     ...
     */
    readonly oauthConfiguration: pulumi.Output<outputs.ZeroTrustAccessApplicationOauthConfiguration | undefined>;
    /**
