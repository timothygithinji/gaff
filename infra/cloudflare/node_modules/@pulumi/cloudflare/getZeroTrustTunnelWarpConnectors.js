...
exports.getZeroTrustTunnelWarpConnectorsOutput = exports.getZeroTrustTunnelWarpConnectors = void 0;
 ...
 * ```
 */
function getZeroTrustTunnelWarpConnectors(args, opts) {
    args = args || {};
...
exports.getZeroTrustTunnelWarpConnectors = getZeroTrustTunnelWarpConnectors;
/**
 * Accepted Permissions
 *
 * - `Cloudflare One Connector: WARP Read`
 ...
 * ```
 */
function getZeroTrustTunnelWarpConnectorsOutput(args, opts) {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getZeroTrustTunnelWarpConnectorsOutput = getZeroTrustTunnelWarpConnectorsOutput;
//# sourceMappingURL=getZeroTrustTunnelWarpConnectors.js.map