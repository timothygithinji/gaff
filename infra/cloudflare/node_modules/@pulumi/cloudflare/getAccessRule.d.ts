 ...
 * ```
 */
export declare function getAccessRule(args?: GetAccessRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetAccessRuleResult>;
/**
 ...
 * ```
 */
export declare function getAccessRuleOutput(args?: GetAccessRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAccessRuleResult>;
/**
 * A collection of arguments for invoking getAccessRule.
 */
export interface GetAccessRuleOutputArgs {
    ...
    filter?: pulumi.Input<inputs.GetAccessRuleFilterArgs | undefined>;
    /**
     * Unique identifier for a rule.
     */
...
//# sourceMappingURL=getAccessRule.d.ts.map