...
console.log(`✓ __PAGE_MODEL resolved. Root keys: ${Object.keys(root).join(", ")}`);
...
const floorplans = pd.floorplans as Array<unknown> | undefined;
...
const images = pd.images as Array<unknown> | undefined;
