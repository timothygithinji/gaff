...
export class TracingSDK {
    ...
    constructor(config) {
        ...
        const commonResources = detectResourcesSync({
            ...
            [SemanticResourceAttributes.SERVICE_NAME]: getEnvVar("OTEL_SERVICE_NAME") ?? "trigger.dev",
        ...
        for (const exporter of config.exporters ?? []) {
            traceProvider.addSpanProcessor(getEnvVar("OTEL_BATCH_PROCESSING_ENABLED") === "1"
