...
exports.ZodMessageSender = exports.ZodMessageHandler = exports.ZodMessageSchema = exports.ZodSchemaParsedError = void 0;
exports.parseMessageFromCatalog = parseMessageFromCatalog;
exports.sendMessageInCatalog = sendMessageInCatalog;
const zod_1 = require("zod");
class ZodSchemaParsedError extends Error {
    error;
    payload;
...
class ZodMessageHandler {
    ...
    parseMessage(message) {
        const parsedMessage = exports.ZodMessageSchema.safeParse(message);
        if (!parsedMessage.success) {
            return {
                success: false,
