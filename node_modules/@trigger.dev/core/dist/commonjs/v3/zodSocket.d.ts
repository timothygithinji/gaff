...
export declare class ZodSocketMessageSender<TMessageCatalog extends ZodSocketMessageCatalogSchema> {
    ...
    sendWithAck<K extends GetSocketMessagesWithCallback<TMessageCatalog>>(type: K, payload: z.input<GetSocketMessageSchema<TMessageCatalog, K>>, timeout?: number): Promise<z.infer<GetSocketCallbackSchema<TMessageCatalog, K>>>;
}
...
export declare class ZodSocketConnection<TClientMessages extends ZodSocketMessageCatalogSchema, TServerMessages extends ZodSocketMessageCatalogSchema> {
    ...
    get sendWithAck(): <K extends GetSocketMessagesWithCallback<TClientMessages>>(type: K, payload: z.input<GetSocketMessageSchema<TClientMessages, K>>, timeout?: number) => Promise<z.TypeOf<GetSocketCallbackSchema<TClientMessages, K>>>;
}
export {};
