...
export function getFullRouterManifest() {
    ...
    if (process.env.NODE_ENV === 'development') {
        ...
        if (!CLIENT_BASE) {
            throw new Error('tanstack/start-router-manifest: TSS_CLIENT_BASE must be defined in your environment for getFullRouterManifest()');
        }
    ...
    const importPath = vinxiClientManifest.inputs[vinxiClientManifest.handler]?.output.path;
    if (!importPath) {
